...
//  MoveBoxUpWithJosh
//
//  Created by Jacob Dobson on 1/4/18.
...
class ViewController: UIViewController, ARSCNViewDelegate {
	...
	@objc func tapped(recognizer: UITapGestureRecognizer) {
		...
		if hitResult.isEmpty { //box is not touched
			print("pressed inside SELF.SCENEVIEW")
		} else { //box is touched
			//changed to "if let" to make cleaner and eliminate the need for adding a bang to each value of newPosition --> "node!.position.x/y/z"
